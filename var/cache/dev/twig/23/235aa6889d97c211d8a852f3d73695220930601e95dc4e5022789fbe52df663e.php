...
class __TwigTemplate_832df3b6a21a6e1628802830058fd6b0bb88896460f67e0c4f1101934b3efec1 extends Template
{
    private $source;
    private $macros = [];
...
\t";
        // line 12
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 12, $this->source); })()), "confirm_password", [], "any", false, false, false, 12), 'row', ["label" => "Confirmez votre mot de passe", "attr" => ["placeholder" => "Confirmez votre mot de passe..."]]);
        echo "
...
";
    ...
    {
        return array (  99 => 16,  92 => 12,  88 => 11,  84 => 10,  80 => 9,  75 => 7,  71 => 5,  61 => 4,  50 => 1,  48 => 2,  35 => 1,);
    }
...
\t{{ form_row(form.confirm_password, {'label':'Confirmez votre mot de passe', 'attr':{'placeholder':'Confirmez votre mot de passe...'}})}}
...
{% endblock %}
", "security/registration.html.twig", "/media/DEV/AFPA/mission-8/marmiton2/templates/security/registration.html.twig");
    }
}
